                ...
                <ul id="search_second_ul">
                    <li>
                        <div class="buttons" style="position:absolute;left:700px;top:47px;">
                            <a href="<c:url value='/cop/com/selectTemplateInfsPop.do'/>" onclick="javascript:fn_egov_select_tmplatInfo('1'); return false;"><img src="/images/img_search.gif" alt="search" />조회 </a>
                        </div>                              
                    </li>
                </ul>           
            </div>          
